...
: ${AMENT_CURRENT_PREFIX:="/root/workspace/src/install/emg_sensor"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/emg_sensor/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/emg_sensor/environment/path.sh"
