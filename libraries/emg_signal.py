...
class Signal:
    def __init__(self, fs=650, lowcut=20.0, highcut=250.0, notch_freq=50.0, window=130, threshold=0.0, multiplier_biceps=1.0, multiplier_triceps=1.0, convolve_window_size=130*4):
        self.fs = fs
        self.lowcut = lowcut
    ...
    def set_multipliers(self, multiplier_biceps, multiplier_triceps, activation_threshold):
        self.multiplier_biceps = multiplier_biceps
        self.multiplier_triceps = multiplier_triceps
