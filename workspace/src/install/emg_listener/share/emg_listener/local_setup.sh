...
: ${AMENT_CURRENT_PREFIX:="/root/workspace/src/install/emg_listener"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/emg_listener/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/emg_listener/environment/path.sh"
