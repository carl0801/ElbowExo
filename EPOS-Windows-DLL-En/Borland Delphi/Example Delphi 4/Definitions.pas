...
{Initialisation}
  ...
  {Subdevice}
    function VCS_OpenSubDevice(DeviceHandle: Longint; DeviceName: PChar; ProtocolStackName: PChar; var pErrorCode: LongWord): Longint; stdcall; external 'EposCmd.dll' name '_VCS_OpenSubDevice@16';
    ...
    function VCS_FindSubDeviceCommunicationSettings(DeviceHandle: Longint; var KeyHandle: Longint; pDeviceName: PChar; pProtocolStackName: PChar; SizeName: Word; var pBaudrate: Longword; var pNodeId: Word; DialogMode: LongInt; var pErrorCode: LongWord): LongBool; stdcall; external 'EposCmd.dll' name '_VCS_FindSubDeviceCommunicationSettings@36';
  ...
  {Info}
    function VCS_GetDriverInfo(pLibraryName: PChar; MaxStrNameSize: Smallint; pLibraryVersion: PChar; MaxStrVersionSize: Smallint; var pErrorCode: LongWord): LongBool; stdcall; external 'EposCmd.dll' name '_VCS_GetDriverInfo@20';
    ...
    function VCS_GetErrorInfo(ErrorCodeValue: Longint; pErrorInfo: PChar; MaxStrSize: Word): LongBool; stdcall; external 'EposCmd.dll' name '_VCS_GetErrorInfo@12';

  {Advanced functions}
    function VCS_GetDeviceNameSelection(StartOfSelection: LongBool; pDeviceNameSel: PChar; MaxStrSize: Word; var pEndOfSelection: LongBool; var pErrorCode: LongWord): LongBool; stdcall; external 'EposCmd.dll' name '_VCS_GetDeviceNameSelection@20';
    function VCS_GetProtocolStackNameSelection(DeviceName: PChar; StartOfSelection: LongBool; pProtocolStackNameSel: PChar; MaxStrSize: Word; var pEndOfSelection: LongBool; var pErrorCode: LongWord): LongBool; stdcall; external 'EposCmd.dll' name '_VCS_GetProtocolStackNameSelection@24';
    function VCS_GetInterfaceNameSelection(DeviceName: PChar; ProtocolStackName: PChar; StartOfSelection: LongBool; pInterfaceNameSel: PChar; MaxStrSize: Word; var pEndOfSelection: LongBool; var pErrorCode: LongWord): LongBool; stdcall; external 'EposCmd.dll' name '_VCS_GetInterfaceNameSelection@28';
    function VCS_GetPortNameSelection(DeviceName: PChar; ProtocolStackName: PChar; InterfaceName: PChar; StartOfSelection: LongBool; pPortSel: PChar; MaxStrSize: Word; var pEndOfSelection: LongBool; var pErrorCode: LongWord): LongBool; stdcall; external 'EposCmd.dll' name '_VCS_GetPortNameSelection@32';
    function VCS_ResetPortNameSelection(DeviceName: PChar; ProtocolStackName: PChar; InterfaceName: PChar; var pErrorCode: LongWord): LongBool; stdcall; external 'EposCmd.dll' name '_VCS_ResetPortNameSelection@16';
    function VCS_GetBaudrateSelection(DeviceName: PChar; ProtocolStackName: PChar; InterfaceName: PChar; PortName: PChar; StartOfSelection: LongBool; var pBaudrateSel: Longint; var pEndOfSelection: LongBool; var pErrorCode: LongWord): LongBool; stdcall; external 'EposCmd.dll' name '_VCS_GetBaudrateSelection@32';
    function VCS_GetKeyHandle(DeviceName: PChar; ProtocolStackName: PChar; InterfaceName: PChar; PortName: PChar; var pKeyHandle: Longint; var pErrorCode: LongWord): LongBool; stdcall; external 'EposCmd.dll' name '_VCS_GetKeyHandle@24';
    function VCS_GetDeviceName(KeyHandle: Longint; pDeviceName: PChar; MaxStrSize: Word; var pErrorCode: LongWord): LongBool; stdcall; external 'EposCmd.dll' name '_VCS_GetDeviceName@16';
    function VCS_GetProtocolStackName(KeyHandle: Longint; pProtocolStackName: PChar; MaxStrSize: Word; var pErrorCode: LongWord): LongBool; stdcall; external 'EposCmd.dll' name '_VCS_GetProtocolStackName@16';
    function VCS_GetInterfaceName(KeyHandle: Longint; pInterfaceName: PChar; MaxStrSize: Word; var pErrorCode: LongWord): LongBool; stdcall; external 'EposCmd.dll' name '_VCS_GetInterfaceName@16';
    function VCS_GetPortName(KeyHandle: Longint; pPortName: PChar; MaxStrSize: Word; var pErrorCode: LongWord): LongBool; stdcall; external 'EposCmd.dll' name '_VCS_GetPortName@16';

  {General}
    function VCS_ImportParameter(KeyHandle: Longint; NodeID: Word; pParameterFileName: PChar; ShowDlg: LongBool; ShowMsg: LongBool; var pErrorCode: LongWord): LongBool; stdcall; external 'EposCmd.dll' name '_VCS_ImportParameter@24';
    function VCS_ExportParameter(KeyHandle: Longint; NodeID: Word; pParameterFileName: PChar; pFirmwareFileName: PChar; pUserID: PChar; pComment: PChar; ShowDlg: LongBool; ShowMsg: LongBool; var pErrorCode: LongWord): LongBool; stdcall; external 'EposCmd.dll' name '_VCS_ExportParameter@36';
...
{Advanced functions}
  ...
  {Sensor}
    ...
    function VCS_SetSsiAbsEncoderParameterEx2(KeyHandle: Longint; NodeID: Word; DataRate: Smallint; NbOfSpecialDataBitsLeading: Smallint; NbOfMultiTurnDataBits: Smallint; NbOfMultiTurnPositionBits: Smallint; NbOfSingleTurnDataBits: Smallint; NbOfSingleTurnPositionBits: Smallint; NbOfSpecialDataBitsTrailing: Smallint; InvertedPolarity: Longint; Timeout: Smallint; PowerupTime: Smallint; CheckFrame: Longint; ReferenceReset: Longint; var pErrorCode: LongWord): LongBool; stdcall; external 'EposCmd.dll' name '_VCS_SetSsiAbsEncoderParameterEx2@60';
    ...
    function VCS_GetSsiAbsEncoderParameterEx2(KeyHandle: Longint; NodeID: Word; var pDataRate: Smallint; var pNbOfSpecialDataBitsLeading: Smallint; var pNbOfMultiTurnDataBits: Smallint; var pNbOfMultiTurnPositionBits: Smallint; var pNbOfSingleTurnDataBits: Smallint; var pNbOfSingleTurnPositionBits: Smallint; var pNbOfSpecialDataBitsTrailing: Smallint; var pInvertedPolarity: Longint; var pTimeout: Smallint; var pPowerupTime: Smallint; var pCheckFrame: Longint; var pReferenceReset: Longint; var pErrorCode: LongWord): LongBool; stdcall; external 'EposCmd.dll' name '_VCS_GetSsiAbsEncoderParameterEx2@60';
...
{Data Recorder}
  ...
  {Data}
    ...
    function VCS_ExportChannelDataToFile(KeyHandle: Longint; NodeID: Word; FileName: PChar; var pErrorCode: LongWord): LongBool; stdcall; external 'EposCmd.dll' name '_VCS_ExportChannelDataToFile@16';
